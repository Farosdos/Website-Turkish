    ...
    <main className='relative isolate min-h-screen'>
      ...
      <div className='mx-auto max-w-7xl px-6 py-16 sm:px-8 sm:py-20 lg:px-12'>
        <header className='mx-auto max-w-3xl text-center'>
          <h1 className='font-bold text-3xl sm:text-4xl lg:text-5xl'>{t.downloads.header.title}</h1>
          ...
          <div className='flex justify-center gap-4'>
            <Button size='lg' asChild className='mt-6 sm:mt-8 transform transition-transform duration-200 hover:scale-105'>
              <a
                ...
                aria-label={`${t.downloads.header.sourceCode} (opens in new tab)`}
              >
                ...
                <span className='text-sm sm:text-base'>{t.downloads.header.sourceCode}</span>
              </a>
            </Button>
          </div>
        </header>
